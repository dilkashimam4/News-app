<template>
  <div
    ...
    style="
      box-shadow: rgb(0, 30, 57) 6px 3px 12px;
      width: fit-content;
      padding-inline: 1rem;
      border-radius: 4rem;
      font-family: cursive;
    "
  >
    <h1 style="padding-block: 0.3rem">Top Headlines</h1>
  </div>
  ...
  <div
    ...
    "
  >
    <h1 style="padding-block: 0.3rem">{{ category }}</h1>
  </div>
  ...
  <div
    ...
    "
  >
    <h1 style="padding-block: 0.3rem">NEWS FROM {{ con }}</h1>
  </div>
  <div
    class="container bg-dark text-white"
    v-if="category !== '' && country !== ''"
  ...
  >
    <h1 style="padding-block: 0.3rem">
      NEWS FROM {{ con }} and Category {{ category }}
    </h1>
  </div>
